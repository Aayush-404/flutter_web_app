...
const playlists = [
  ...
  'Chill',
  'Background',
  'The playlist to calm the mind by Utkarsh and Aayush',
  'Vibes Right Now',
  'Time Capsule',
  'On Repeat',
  'Summer Rewind',
...
const lofihiphopPlaylist = Playlist(
  id: '5-playlist',
  name: 'The playlist to calm the mind',
  imageURL: 'assets/lofigirl.jpg',
  description:
      'Wanna study? Want peace of mind? Wish to relax? or just some soothing beats to take a break? You have come to the right place📚',
  creator: 'Utkarsh & Aayush',
  duration: ' half an hour (approx)',
  followers: '38,429',
